          ...
          {isPharmacy && (
            <>
              <Link
                ...
                className="inline-flex h-9 items-center gap-1.5 rounded-lg border border-white/[0.06] bg-cinema-elev px-3 text-[13px] font-medium text-white/65 transition-colors hover:border-primary hover:text-primary"
              ...
              <button
                ...
                className="inline-flex h-9 items-center gap-1.5 rounded-lg border border-primary/30 bg-primary/[0.08] px-3 text-[13px] font-medium text-primary transition-colors hover:bg-primary hover:text-white"
              >
                <Truck size={15} />
                ...
                return (
                  <button
                    ...
                    className={`rounded-md px-3 py-1 text-[12px] font-medium transition-colors ${
                      active ? "bg-amber-500/15 text-amber-300" : "text-white/65 hover:text-white"
                    }`}
                    aria-pressed={active}
                ...
                {products.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="group transition-colors hover:bg-white/[0.02]">
                      ...
                      <td className="whitespace-nowrap px-5 py-3.5 text-[14px] text-white/65">{p.category ?? "—"}</td>
                        ...
                        <td className="whitespace-nowrap px-5 py-3.5">
                          {p.expiryDate ? (
                            <div className="flex flex-col gap-1">
                              <span className={`font-mono text-[12px] ${exp === "expired" ? "text-rose-200" : exp === "expiring_soon" ? "text-amber-300" : "text-white/65"}`}>
