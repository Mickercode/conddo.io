  ...
  return (
    <SettingsShell active="danger" title="Danger Zone" description="Irreversible and destructive actions. Proceed with care.">
      <div className="space-y-4">
        <div className="flex flex-col gap-4 rounded-xl border border-danger/30 bg-cinema-elev p-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-rose-500/[0.06] text-rose-200">
              <PauseCircle size={20} />
            </span>
            <div>
              <h3 className="text-[15px] font-medium text-white">Deactivate business</h3>
              <p className="mt-1 max-w-md text-[14px] leading-relaxed text-white/65">
          ...
          <button
            ...
            className="shrink-0 rounded-md border border-danger bg-cinema-elev px-4 py-2.5 text-[14px] font-medium text-rose-200 transition-colors hover:bg-danger hover:text-white"
          >
            Deactivate
          </button>
        </div>
        ...
        <div className="flex flex-col gap-4 rounded-xl border border-danger/30 bg-cinema-elev p-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-[15px] font-medium text-white">Delete business</h3>
              <p className="mt-1 max-w-md text-[14px] leading-relaxed text-white/65">
          ...
          <button
            ...
            className="shrink-0 cursor-not-allowed rounded-md border border-white/[0.06] bg-cinema-elev px-4 py-2.5 text-[14px] font-medium text-white/45"
          >
            Delete permanently
          </button>
        </div>
